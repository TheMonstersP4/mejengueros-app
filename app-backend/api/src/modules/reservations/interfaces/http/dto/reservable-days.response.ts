...
export class ReservableDaysResponse {
  ...
  @ApiProperty({
    ...
    description:
      'Upcoming Costa Rica business dates that still have at least one future reservable one-hour slot after applying court availability, confirmed reservation filtering, and the same-day 30-minute minimum advance threshold.'
  })

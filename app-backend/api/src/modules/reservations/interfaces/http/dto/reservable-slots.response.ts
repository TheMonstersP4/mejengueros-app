...
export class ReservableSlotsResponse {
  ...
  @ApiProperty({
    ...
    description:
      'UTC one-hour slot candidates for the selected Costa Rica business date after excluding confirmed reservations and any current-day slots that do not clear the 30-minute minimum advance threshold.'
  })

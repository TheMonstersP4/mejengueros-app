...
1. Dado un complejo, cuando el dueño registra un servicio común, entonces el servicio queda asociado al complejo.
2. Dada una cancha, cuando el dueño registra un servicio específico de esa cancha, entonces el servicio queda asociado a la cancha.
